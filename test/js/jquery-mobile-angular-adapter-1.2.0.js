...
(function (angular, $) {
    ...
    //             // EDIT: BUG on android content://
    //             console.log("href: "+href+"="+href.replace(/^.*?\:\/\/[^\/]*/, ''));
...
(function ($, angular) {
    ...
    function waitDialogFactory(rootScope) {
        ...
        $.mobile.document.delegate(".ui-loader", "vclick", onClick);
         ...
         */
        $.mobile.document.on('pageshow', 'div', function (event, ui) {
            updateUi();
        });
